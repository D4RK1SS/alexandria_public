...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    idProcurar.addEventListener("input", function(event) {
        //console.clear();
        let materiasId = [document.getElementById("WWI"), document.getElementById("WWII"), document.getElementById("BrasilColonial"),
            document.getElementById("GuerraFria"), document.getElementById("PreHistoria")
        ]
